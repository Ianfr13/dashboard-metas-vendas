                ...
                <Table className="min-w-[800px]">
                    <TableHeader>
                        <TableRow>
                            ...
                            {level === 'adset' && (
                                <TableHead style={{ minWidth: '180px' }}>Campanha</TableHead>
                            )}
                            {level === 'ad' && (
                                <>
                                    <TableHead style={{ minWidth: '180px' }}>Campanha</TableHead>
                                    <TableHead style={{ minWidth: '180px' }}>Conjunto</TableHead>
                                </>
                            )}
                            ...
                            <TableRow key={row.id || idx}>
                                ...
                                {level === 'adset' && (
                                    <TableCell className="text-sm text-muted-foreground">
                                        <div className="max-w-[180px] truncate" title={row.campaignName}>
                                            {row.campaignName}
                                        </div>
                                    </TableCell>
                                )}
                                {level === 'ad' && (
                                    <>
                                        ...
                                        <TableCell className="text-sm text-muted-foreground">
                                            <div className="max-w-[180px] truncate" title={row.adsetName}>
                                                {row.adsetName}
                                            </div>
                                        </TableCell>
                                    </>

...
export function AccessDenied({
    message = "Apenas usuários autorizados podem acessar esta página.",
    requiredRole = "admin ou master"
}: {
    message?: string,
    requiredRole?: string
}) {
        ...
        <DashboardLayout>
            <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200 max-w-md w-full mb-6 text-left">
                    ...
                    <p className="text-xs text-yellow-700 font-mono mt-2">Necessário: {requiredRole}</p>

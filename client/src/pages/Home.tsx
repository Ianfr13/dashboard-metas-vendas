  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-amber-50 flex items-center justify-center p-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto lg:mx-0">
            <div className="flex items-start gap-3 p-4 bg-white/60 backdrop-blur-sm rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Acompanhe suas metas diariamente</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-white/60 backdrop-blur-sm rounded-lg">
              ...
              <div>
                <h3 className="font-semibold text-gray-800">Análises Detalhadas</h3>
                <p className="text-sm text-gray-600">Métricas e funis de conversão</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-white/60 backdrop-blur-sm rounded-lg">
              ...
              <div>
                <h3 className="font-semibold text-gray-800">Gestão de Metas</h3>
                <p className="text-sm text-gray-600">Crie e gerencie sub-metas</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-white/60 backdrop-blur-sm rounded-lg">
              ...
              <div>
                <h3 className="font-semibold text-gray-800">Ranking de Time</h3>
                <p className="text-sm text-gray-600">Compare performance</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  <Button
                    ...
                    className="w-full h-14 text-lg bg-white hover:bg-gray-50 text-gray-800 border-2 border-gray-200 shadow-md hover:shadow-lg transition-all duration-300"
                  >
      ...
      <div className="absolute bottom-4 left-0 right-0 text-center text-sm text-gray-500">
        <p>© 2024 Douravita. Todos os direitos reservados.</p>
      </div>
    </div>
  );
}
